...
SKELETONS: dict[str, dict[str, list[tuple[str, str, str, str, str]]]] = {
    # SPARSE skeletons: only 5–7 anchors per day. Gaps between anchors
    # (typically 1.5–3h each, 4–6h total per day) are left EMPTY so the
    # `slot_filler` can pick a fragment based on persona + memory + perception.
    "undergrad": {
        "monday": [
            ("07:00", "07:30", "wake_up", DORM, "起床洗漱"),
            ("08:00", "10:00", "attend_class", CLASSROOM, "周一早课"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:00", "16:00", "attend_lecture", LECTURE, "周一下午公选课"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "tuesday": [
            ("07:30", "08:00", "wake_up", DORM, "起床"),
            ("09:00", "11:30", "lab_work", LAB, "周二上午实验课"),
            ("12:30", "13:00", "have_lunch", DINING, "午饭"),
            ("14:30", "16:00", "lab_work", LAB, "实验报告"),
            ("18:30", "19:00", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "wednesday": [
            ...
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:30", "16:00", "group_discussion", DISCUSSION_LAB, "小组讨论"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "thursday": [
            ("07:30", "08:00", "wake_up", DORM, "起床"),
            ("08:30", "10:30", "attend_lecture", LECTURE, "周四选修"),
            ("12:30", "13:00", "have_lunch", DINING, "午饭"),
            ("14:30", "16:00", "self_study", LIBRARY, "图书馆任务"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "friday": [
            ...
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:00", "15:30", "attend_class", CLASSROOM, "周五下午课"),
            ("18:30", "19:00", "have_dinner", DINING, "周五聚餐"),
            ("23:30", "23:55", "sleep", DORM, "睡觉"),
        ],
        "saturday": [
        ...
        "sunday": [
            ...
            ("10:00", "12:00", "self_study", LIBRARY, "补作业"),
            ("12:30", "13:00", "have_lunch", DINING, "午饭"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("22:30", "23:00", "sleep", DORM, "早睡"),
        ],
    },
    "grad": {
        "monday": [
            ("08:00", "08:30", "wake_up", DORM, "起床"),
            ("09:00", "11:30", "lab_work", LAB, "上午实验"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:00", "17:00", "lab_work", LAB, "下午实验/写代码"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "tuesday": [
            ("08:00", "08:30", "wake_up", DORM, "起床"),
            ("09:00", "10:30", "group_discussion", DISCUSSION_LAB, "周二组会"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:30", "16:30", "lab_work", LAB, "做实验"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "wednesday": [
            ("08:30", "09:00", "wake_up", DORM, "起床"),
            ("09:30", "11:30", "lab_work", LAB, "上午实验"),
            ("12:30", "13:00", "have_lunch", DINING, "午饭"),
            ("14:00", "15:30", "attend_lecture", LECTURE, "周三专题课"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "thursday": [
            ...
            ("09:00", "11:30", "lab_work", LAB, "上午实验"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:30", "16:30", "group_discussion", DISCUSSION_LAB, "课题讨论"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "friday": [
            ("08:30", "09:00", "wake_up", DORM, "起床"),
            ("09:30", "11:30", "lab_work", LAB, "周五早实验"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:00", "16:00", "lab_work", LAB, "周五收尾"),
            ("18:00", "18:30", "have_dinner", DINING, "和组内聚餐"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "saturday": [
        ...
        "sunday": [
            ...
            ("12:30", "13:00", "have_lunch", DINING, "午饭"),
            ("14:30", "16:30", "lab_work", LAB, "准备下周组会"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
    },
    "faculty": {
        "monday": [
            ("07:00", "07:30", "wake_up", DORM, "起床"),
            ("08:00", "10:00", "give_lecture", LECTURE, "周一早课"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:00", "15:30", "give_lecture", CLASSROOM, "下午专业课"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "tuesday": [
            ("07:00", "07:30", "wake_up", DORM, "起床"),
            ("09:00", "10:30", "group_discussion", DISCUSSION_LAB, "组会"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:00", "16:00", "give_lecture", LECTURE, "周二专题讲座"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "wednesday": [
            ("07:30", "08:00", "wake_up", DORM, "起床"),
            ("09:00", "11:00", "give_lecture", CLASSROOM, "周三上午课"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:30", "16:00", "office_hours", DISCUSSION_LAB, "下午答疑"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "thursday": [
            ("07:00", "07:30", "wake_up", DORM, "起床"),
            ("08:30", "10:30", "give_lecture", LECTURE, "周四早课"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:00", "15:30", "group_discussion", DISCUSSION_LAB, "项目会议"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "friday": [
            ("07:00", "07:30", "wake_up", DORM, "起床"),
            ("08:30", "10:00", "give_lecture", CLASSROOM, "周五早课"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:30", "16:00", "office_hours", DISCUSSION_LAB, "周五答疑"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "saturday": [
        ...
        "sunday": [
            ("08:00", "08:30", "wake_up", DORM, "起床"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:30", "16:30", "self_study", LIBRARY, "准备下周讲义"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "早睡"),
        ],
    },
    "logistics": {
        "monday": [
            ("06:00", "06:30", "wake_up", DORM, "早起"),
            ("07:00", "09:30", "patrol", GARDEN_LOW, "上午巡查"),
            ("11:30", "12:00", "have_lunch", KITCHEN, "午饭"),
            ("14:00", "16:30", "patrol", GARDEN_LOW, "下午继续值班"),
            ("17:30", "18:00", "have_dinner", KITCHEN, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "tuesday": [
            ("06:00", "06:30", "wake_up", DORM, "早起"),
            ("07:00", "09:30", "patrol", GARDEN_ROOF, "周二屋顶花园检查"),
            ("11:30", "12:00", "have_lunch", KITCHEN, "午饭"),
            ("14:00", "16:00", "patrol", DORM, "宿舍楼下午巡查"),
            ("17:30", "18:00", "have_dinner", KITCHEN, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "wednesday": [
            ("06:00", "06:30", "wake_up", DORM, "早起"),
            ("07:00", "09:30", "patrol", LIBRARY, "周三图书馆区巡查"),
            ("11:30", "12:00", "have_lunch", KITCHEN, "午饭"),
            ("14:00", "16:00", "patrol", LECTURE, "周三下午教学楼"),
            ("17:30", "18:00", "have_dinner", KITCHEN, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "thursday": [
            ("06:00", "06:30", "wake_up", DORM, "早起"),
            ("07:00", "09:30", "patrol", LAB, "周四实验楼检查"),
            ("11:30", "12:00", "have_lunch", KITCHEN, "午饭"),
            ("14:00", "16:00", "patrol", LAB, "下午继续"),
            ("17:30", "18:00", "have_dinner", KITCHEN, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "friday": [
            ("06:00", "06:30", "wake_up", DORM, "早起"),
            ("07:00", "09:30", "patrol", CLASSROOM, "周五教学楼"),
            ("11:30", "12:00", "have_lunch", KITCHEN, "午饭"),
            ("14:00", "16:00", "patrol", LIBRARY, "下午图书馆"),
            ("17:30", "18:00", "have_dinner", KITCHEN, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "saturday": [
            ("07:00", "07:30", "wake_up", DORM, "起床"),
            ("08:00", "10:00", "patrol", GARDEN_LOW, "周末花园巡查"),
            ("12:00", "12:30", "have_lunch", KITCHEN, "午饭"),
            ("17:30", "18:00", "have_dinner", KITCHEN, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "sunday": [
            ("07:00", "07:30", "wake_up", DORM, "起床"),
            ("08:00", "10:00", "patrol", GARDEN_ROOF, "周日屋顶巡查"),
            ("12:00", "12:30", "have_lunch", KITCHEN, "午饭"),
            ("17:30", "18:00", "have_dinner", KITCHEN, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "早睡"),
        ],
    ...
    "other": {
        "monday": [
            ("07:30", "08:00", "wake_up", DORM, "起床"),
            ("09:00", "11:00", "self_study", LIBRARY, "图书馆"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:00", "16:00", "self_study", LIBRARY, "继续"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "tuesday": [
        ...
        "wednesday": [
            ...
            ("09:00", "11:00", "self_study", LIBRARY, "图书馆"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("14:00", "15:30", "group_discussion", DISCUSSION_LAB, "讨论"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "thursday": [
        ...
        "friday": [
            ...
            ("09:00", "11:00", "self_study", LIBRARY, "图书馆"),
            ("12:00", "12:30", "have_lunch", DINING, "午饭"),
            ("18:00", "18:30", "have_dinner", DINING, "周五聚餐"),
            ("23:00", "23:30", "sleep", DORM, "睡觉"),
        ],
        "saturday": [
        ...
        "sunday": [
            ("08:30", "09:00", "wake_up", DORM, "起床"),
            ("10:00", "12:00", "self_study", LIBRARY, "整理一周"),
            ("12:30", "13:00", "have_lunch", DINING, "午饭"),
            ("18:00", "18:30", "have_dinner", DINING, "晚饭"),
            ("23:00", "23:30", "sleep", DORM, "早睡"),
        ],
...
def _ensure_pre_dawn_sleep(blocks: list[tuple[str, str, str, str, str]]) -> list[tuple[str, str, str, str, str]]:
    """Inject a 00:00–wake_up sleep block so the slot_filler does not fill
    the pre-dawn empty hours with fragments (NPCs would otherwise be
    "chatting" at 03:00). Idempotent.
    """
    if not blocks:
        return blocks
    first = blocks[0]
    start = first[0]
    if start <= "00:00":
        return blocks  # nothing to prepend
    if first[2] == "sleep" and first[0] == "00:00":
        return blocks  # already inserted
    pre = ("00:00", start, "sleep", DORM, "凌晨睡眠")
    return [pre] + list(blocks)
...
def build_template(persona: dict) -> dict:
    ...
    for d in WEEKDAYS:
        ...
        # Lock the pre-dawn hours as sleep so fragments don't fill them.
        mutated = _ensure_pre_dawn_sleep(mutated)
        blocks = []
