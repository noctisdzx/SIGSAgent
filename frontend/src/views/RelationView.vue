...
.legend-line { width: 18px; height: 3px; border-radius: 0; }
...
.sim-now b { color: var(--accent-warn); margin: 0 4px; font-family: var(--font-mono); }
...
.slot-row .tl-time {
  ...
  font-family: var(--font-mono); min-width: 90px;
}
